...
// https://github.com/IntelligentRoboticsLabs/ros2_planning_system/tree/master/plansys2_popf_plan_solver
  ...
  const std::string & node_namespace)
{
  ...
  system(
    ("ros2 run optic_plan_solver optic " +
  ...
  const std::string & node_namespace)
{
  ...
  system(
    ("ros2 run optic_plan_solver optic /tmp/" + node_namespace + "/check_domain.pddl /tmp/" +
